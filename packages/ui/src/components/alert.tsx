...
// Root element
function AlertRoot({ className, variant = "default", style, ...props }: AlertRootProps) {
	return (
		<div
			role="alert"
			className={cn(
...
// Text column
function AlertBody({ className, ...props }: React.HTMLAttributes<HTMLDivElement>) {
	return (
		<div
...
function AlertDescription({
	...
	return (
		<div
			className={cn("text-sm opacity-90 [&_p]:leading-relaxed mt-0.5", className)}
			{...props}
		/>
	);
}
