...
type CheckboxPrimitiveProps = React.ComponentPropsWithoutRef<typeof CheckboxPrimitive>;
...
>(({ className, error, children, ...props }, ref) => (
	...
	>
		{({ isSelected }) => (
			<>
				<span className={cn("flex items-center justify-center text-current", !isSelected && "hidden")}>
