        ...
        {showArrow ? (
          <OverlayArrow className="group">
            <svg
              ...
              height={12}
              viewBox="0 0 12 12"
              className="block fill-popover stroke-[var(--border)] stroke-1 group-placement-bottom:rotate-180 group-placement-left:-rotate-90 group-placement-right:rotate-90"
            >
