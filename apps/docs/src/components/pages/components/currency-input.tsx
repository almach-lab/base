      ...
      examples={[
        {
          title: "Default",
          description:
            "Defaults to USD. Click the flag/code button to change currency.",
          preview: (
  ...
  <p className="text-sm text-muted-foreground">
    {val.currency} {val.amount.toLocaleString()}
        ...
        },
        {
          title: "With label",
          description:
            "Pair with a Label using a matching id for accessibility.",
          preview: (
...
<p className="text-xs text-destructive">Please enter a valid amount.</p>`,
        ...
        },
        {
          title: "Disabled",
          description:
            "Prevents interaction with both the amount field and currency selector.",
          preview: (
            <div className="w-full max-w-xs">
              <Input.Currency
        ...
        },
        {
          ...
          description:
            "Currency is fixed — shows as a static badge with no dropdown. Amount remains editable.",
          preview: (
            <div className="w-full max-w-xs">
              <Input.Currency
        ...
        },
        {
          ...
          description:
            "Entire selector hidden — only the symbol and amount are shown.",
          preview: (
            <div className="w-full max-w-xs">
              <Input.Currency
                value={{ amount: 100000, currency: "IDR" }}
        ...
        },
        {
          ...
          description:
            "Pass renderFlag to use real flag images from flagcdn.com (or any source).",
...
/>`,
        },
        {
          ...
          description:
            "Open the selector and type to filter by code, name, or symbol.",
...
<Input.Currency currencies={LIMITED} />`,
      ...
      props={[
        ...
        },
        {
          ...
          default: '"USD"',
          description:
            "Initial currency code when uncontrolled (no value prop). Ignored when value is supplied — use value.currency instead.",
        },
        {
          name: "currencies",
          type: "CurrencyDef[]",
        ...
        },
        {
          ...
          description:
            "Custom flag renderer. Receives the ISO 3166-1 alpha-2 country code and the full CurrencyDef. Use for CDN images, SVG flag libraries, or any React node. Return null to hide.",
        },
        {
          ...
          default: '"editable"',
          description:
            'Controls the left selector. "editable" = dropdown; "readonly" = static badge, no dropdown; "hidden" = selector removed entirely.',
        },
        {
          name: "error",
          type: "boolean",
        ...
        },
        {
          ...
          type: "string",
          description:
            "Forwarded to the inner amount input for label association.",
        },
        {
          name: "className",
          type: "string",
  ...
  return (
    <div className="flex w-full max-w-xs flex-col gap-2">
      ...
      <p className="text-xs text-muted-foreground">
        Try searching "kr" to find NOK, SEK, DKK — or "peso" for Latin
        currencies.
      </p>
    </div>
  );
