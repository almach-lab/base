import { Checkbox, Input, Label } from "@almach/ui";
      ...
      examples={[
        {
          title: "With input",
          description:
            "Link a label to an input using matching htmlFor and id.",
          preview: (
...
<Input id="password" type="password" placeholder="••••••••" />`,
        ...
        },
        {
          title: "With checkbox",
          description:
            "Labels work with any focusable control, including checkboxes.",
          preview: (
      ...
      props={[
        {
          ...
          type: "string",
          description:
            "The id of the associated form control. Clicking the label focuses it.",
        },
        {
          name: "required",
          type: "boolean",
