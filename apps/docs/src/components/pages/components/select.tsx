  ...
  <Select.Content>
    ...
    <Select.Group>
      ...
      <Select.Item value="remix">Remix</Select.Item>
				...
				{
					title: "Searchable",
					description: "Select.Searchable adds a live-filter search input — replaces the old Combobox component.",
...
/>`,
				...
				{
					title: "Error state",
					description: "Pass error to Select.Trigger or Select.Searchable to show validation feedback.",
					preview: (
						<div className="w-full max-w-xs space-y-3">
							<div className="space-y-1.5">
								...
								<p className="text-xs text-destructive">Please select a framework.</p>
							</div>
							<div className="space-y-1.5">
...
<Select disabled>…</Select>`,
			...
			props={[
				...
				},
				{
					...
					type: "boolean",
					default: "false",
					description: "Applies destructive ring and aria-invalid on the trigger.",
				},
				{
				...
				},
				{
					...
					type: "(value: string) => void",
					description: "Called when an option is selected. Re-selecting the current value clears it.",
				},
				{
