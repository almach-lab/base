	...
	return (
		<ComponentDoc
			...
			examples={[
				{
					title: "With image",
					description: "Image loads first; fallback renders if it fails or is missing.",
					preview: (
				...
				},
				{
					...
					preview: (
						<div className="flex -space-x-2">
							{[
								{ src: "https://images.unsplash.com/photo-1535713875002-d1d0cf377fde?w=64&h=64&fit=crop&crop=face", initials: "AB" },
								{ src: "https://images.unsplash.com/photo-1494790108377-be9c29b29330?w=64&h=64&fit=crop&crop=face", initials: "CD" },
								{ src: "https://images.unsplash.com/photo-1599566150163-29194dcaad36?w=64&h=64&fit=crop&crop=face", initials: "EF" },
								{ initials: "+4" },
							].map(({ src, initials }) => (
								<Avatar
									key={initials}
								...
								>
									{src && (
										<Avatar.Image src={src} alt={initials} />
									)}
			...
			props={[
				{
					...
					default: '"default"',
					description: "Diameter of the avatar (sm=24 px, default=36 px, lg=48 px, xl=64 px).",
				},
				{
				...
				},
				{
					...
					type: "ReactNode",
					description: "Content shown when the image is missing or fails to load.",
				},
			]}
		/>
	);
