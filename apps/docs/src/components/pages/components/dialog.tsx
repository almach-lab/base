              ...
              <Dialog.Content>
                <Dialog.Header>
                  ...
                  <Dialog.Description>
                    ...
                    projects, settings, and history — will be permanently
                    deleted.
                  </Dialog.Description>
                </Dialog.Header>
                <Dialog.Footer>
    ...
    <Dialog.Footer>
      ...
      props={[
        ...
        },
        {
          ...
          description:
            "The dialog panel. Includes a close (×) button by default.",
        },
        {
          name: "Dialog.Close",
          type: "DialogCloseProps",
          description:
            "Closes the dialog on click. Use asChild to wrap a Button.",
        },
      ]}
    />
  );
