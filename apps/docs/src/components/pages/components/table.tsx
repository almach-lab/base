import { Badge, type ColumnDef, Table } from "@almach/ui";
      ...
      examples={[
        {
          ...
          preview: <Table.Data columns={userColumns} data={USERS} />,
...
/>`,
        },
        {
          title: "Paginated",
          description:
            "Add paginated and set pageSize to split data across pages.",
          preview: (
            <Table.Data
              columns={userColumns}
              data={USERS}
