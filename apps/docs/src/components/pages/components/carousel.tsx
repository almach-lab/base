import { Badge, Card, Carousel } from "@almach/ui";
...
export function CarouselPage() {
      ...
      examples={[
        {
          title: "With arrows",
          description:
            "Carousel.Previous and Carousel.Next float over the slides.",
          preview: (
  ...
  <Carousel.Next />
        ...
        },
        {
          title: "With dots",
          description:
            "Add Carousel.Dots below the content for page indicators.",
          preview: (
            <Carousel className="w-full max-w-md">
              <Carousel.Content>
                {SLIDES.map((s) => (
  ...
  <Carousel.Next />
        ...
        },
        {
          title: "Card slides",
          description:
            "Use Card inside each Carousel.Item for structured content.",
          preview: (
