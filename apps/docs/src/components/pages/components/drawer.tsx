	...
	return (
		<ComponentDoc
			...
			examples={[
				{
					title: "Action sheet",
					description: "A list of actions — the most common bottom-sheet pattern.",
					preview: (
						<Drawer>
    ...
    <Drawer.Footer>
      <Drawer.Close asChild>
        <Button variant="outline" className="w-full">Cancel</Button>
				...
				{
					title: "Form drawer",
					description: "Inline editing or quick-add forms work well in drawers.",
					preview: (
						<Drawer>
							<Drawer.Trigger asChild>
        ...
        <Button variant="outline" className="w-full">Cancel</Button>
			...
			props={[
				...
				},
				{
					...
					description: "The sheet panel. Includes a drag handle at the top automatically.",
				},
				{
					name: "Drawer.Header",
				...
				},
				{
					...
					description: "Closes the drawer on click. Use asChild to wrap a Button.",
				},
			]}
		/>
	);
