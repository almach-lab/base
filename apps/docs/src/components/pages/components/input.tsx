...
<p className="text-xs text-destructive">Enter a valid email address.</p>`,
        ...
        },
        {
          ...
          preview: (
            <div className="w-full max-w-sm space-y-1.5 opacity-50">
              ...
              <Input id="dis-demo" disabled defaultValue="alice_johnson" />
            </div>
          ),
  ...
  <Input id="username" disabled defaultValue="alice_johnson" />
        ...
        },
        {
          ...
          description:
            "Click a segment and type, or use ↑ ↓ arrow keys. Press / or → to advance between segments.",
          preview: <Input.Date />,
          code: `<Input.Date />`,
        },
        {
          ...
          description:
            "Day-first format common in Europe and most of the world.",
        ...
        },
        {
          ...
          description:
            "Switch format at runtime — segments reorder accordingly.",
...
<div className="flex flex-col gap-3">
  ...
  <Input.Date format={fmt} value={date} onChange={setDate} withCalendar />
        ...
        },
        {
          ...
          description:
            "Add withCalendar to show a calendar icon that opens a date picker popover.",
...
{date && <p className="text-sm">{date.toLocaleDateString()}</p>}`,
  ...
  <Input.Date id="dob" withCalendar />
        ...
        // ── Input.Currency ──────────────────────────────────────────
        {
          ...
          description:
            "Defaults to USD. Click the flag/code button to open the currency selector.",
          preview: (
        ...
        },
        {
          ...
          description:
            "Bind value and onChange to manage amount and currency in state.",
...
<Input.Currency id="price" />`,
        ...
        },
        {
          ...
          description:
            "Pass error to show a destructive border and focus ring.",
          preview: (
            <div className="w-full max-w-xs space-y-1.5">
              <Label htmlFor="price-err" required>
                Amount
              </Label>
...
<p className="text-xs text-destructive">Please enter a valid amount.</p>`,
        ...
        },
        {
          ...
          description:
            'currencySelector controls the left side: "editable" (default), "readonly" (static badge), or "hidden" (removed).',
          preview: (
            <div className="w-full max-w-xs space-y-2">
              <Input.Currency
                value={{ amount: 100000, currency: "IDR" }}
                currencySelector="readonly"
              />
              <Input.Currency
                value={{ amount: 100000, currency: "IDR" }}
                currencySelector="hidden"
              />
            </div>
          ),
...
<Input.Currency currencySelector="hidden" />`,
        ...
        },
        {
          ...
          preview: (
            <div className="w-full max-w-xs">
              <Input.Currency
                value={{ amount: 9999, currency: "GBP" }}
                disabled
              />
            </div>
          ),
      ...
      props={[
        ...
        },
        {
          ...
          default: "false",
          description:
            "Prevents interaction. Renders at 50% opacity with a not-allowed cursor.",
        },
        {
          name: "type",
          type: "string",
          default: '"text"',
          description:
            "Standard HTML input type (email, password, number, etc.).",
        },
        {
          ...
          default: '"MM/DD/YYYY"',
          description:
            'Controls segment order and separator. Tokens: MM, DD, YYYY. Examples: "DD/MM/YYYY" | "YYYY-MM-DD" | "DD-MM-YYYY".',
        },
        {
        ...
        },
        {
          ...
          description:
            "Called when all segments form a valid date, or undefined when incomplete.",
        },
        {
          ...
          default: "false",
          description:
            "Show a calendar icon button that opens a date picker popover.",
        },
        {
        ...
        },
        {
          ...
          description:
            "Controlled value — the numeric amount and ISO currency code.",
        },
        {
          name: "Input.Currency — onChange",
          type: "(value: { amount: number | null; currency: string }) => void",
          description:
            "Called on every amount keystroke and on currency change.",
        },
        {
          ...
          default: '"USD"',
          description:
            "Initial currency code when uncontrolled (no value prop). Ignored when value is supplied.",
        },
        {
          ...
          description:
            "Custom flag renderer — use CDN images, SVG libraries, or any React node. countryCode is ISO 3166-1 alpha-2.",
        },
        {
          name: "Input.Currency — currencies",
          type: "CurrencyDef[]",
          description:
            "Override the currency list. Defaults to the built-in CURRENCIES (36 entries). Mark entries with popular: true to show them in the Popular group.",
        },
        {
        ...
        },
        {
          ...
          default: '"editable"',
          description:
            'Controls the left selector. "editable" = dropdown; "readonly" = static badge, no dropdown; "hidden" = entire selector removed.',
        },
        {
          ...
          default: "false",
          description:
            "Applies destructive border and focus ring; sets aria-invalid on the amount input.",
        },
        {
