	...
	return (
		<ComponentDoc
			...
			examples={[
				{
					title: "Account menu",
					description: "A typical profile/account dropdown with keyboard shortcuts.",
					preview: (
						<DropdownMenu>
  ...
  <DropdownMenu.Content align="start" className="w-52">
    ...
    <DropdownMenu.Item destructive>
      ...
      Sign out
				...
				{
					title: "Team switcher",
					description: "Grouped items for switching between workspaces or contexts.",
					preview: (
						<DropdownMenu>
							<DropdownMenu.Trigger asChild>
  ...
  Delete
			...
			props={[
				...
				},
				{
					...
					description: "Keyboard shortcut hint aligned to the right of the item.",
				},
			]}
		/>
	);
