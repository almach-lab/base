            ...
            <Collapsible className="w-full max-w-sm rounded-xl border px-4">
              ...
              <Collapsible.Content>
                <p className="pb-4 text-sm text-muted-foreground leading-relaxed">
                  Almach is a component library styled with Tailwind CSS v4. It
                  provides accessible, composable components with a clean API.
                </p>
              </Collapsible.Content>
            </Collapsible>
          ),
  ...
  <Collapsible.Content>
	...
	Almach is a component library with accessible, composable primitives…
        ...
        },
        {
          title: "FAQ list",
          description:
            "Stack multiple collapsibles for an accordion-style FAQ.",
          preview: (
  ...
  return (
    <div className="flex w-full max-w-sm flex-col gap-2">
      ...
      >
        ...
        <Collapsible.Content>
          <p className="pb-4 text-sm text-muted-foreground leading-relaxed">
            These settings are for power users. Be careful before making
            changes.
          </p>
        </Collapsible.Content>
      </Collapsible>
