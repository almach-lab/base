	...
	return (
		<ComponentDoc
			...
			examples={[
				{
					title: "Variants",
					description: "Four semantic variants for different feedback contexts.",
					preview: (
...
<Alert variant="destructive">
  ...
  <Alert.Body>
    ...
    <Alert.Description>Please update your billing information.</Alert.Description>
				...
				{
					title: "Without icon",
					description: "Alert.Icon is optional — the body fills the full width.",
					preview: (
						<div className="w-full max-w-lg space-y-3">
							<Alert variant="warning">
								<Alert.Body>
      ...
      The platform will be unavailable on Sunday from 2:00–4:00 AM UTC.
			...
			props={[
				...
				},
				{
					...
					description: "Optional icon slot. Icons are sized to 16×16 px automatically.",
				},
				{
					name: "Alert.Title",
