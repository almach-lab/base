import { Card, SwipeActions } from "@almach/ui";
...
const EMAILS = [
  ...
  },
  {
    ...
    preview: "Are you coming to lunch?",
    time: "1h ago",
    unread: false,
  },
  {
    ...
    preview: "The new mockups look great!",
    time: "3h ago",
    unread: true,
  },
];
    ...
    >
      ...
      <SwipeActions.Content className="bg-background px-4 py-4">
        ...
        <p className="mt-2 text-xs text-muted-foreground">
          Swipe right to reveal Pay — or drag all the way across to confirm
          instantly.
        </p>
      ...
      examples={[
        {
          ...
          description:
            "SwipeActions.Right slot reveals Archive + Delete when swiped left.",
          centered: false,
          preview: (
  ...
  <SwipeActions.Content className="bg-background px-4 py-3">
    {/* row content */}
        ...
        },
        {
          ...
          description:
            "Left slot (swipe right) to complete. Right slot (swipe left) to delete.",
          centered: false,
          preview: (
            <div className="w-full max-w-sm divide-y rounded-xl overflow-hidden border">
              {tasks.map((task) => (
    ...
    <div className="flex items-center justify-between">
      ...
      <p className="text-lg font-bold">$42.00</p>
        ...
        },
        {
          ...
          description:
            "Top slot (swipe down) and Bottom slot (swipe up) for vertical actions.",
          preview: (
            <SwipeActions className="w-full max-w-sm rounded-xl">
              <SwipeActions.Top>
                <SwipeActions.Action variant="secondary">
                  <Share2 /> Share
                </SwipeActions.Action>
                <SwipeActions.Action variant="warning">
                  <Pin /> Pin
                </SwipeActions.Action>
                <SwipeActions.Action variant="default">
                  <Star /> Star
                </SwipeActions.Action>
              </SwipeActions.Top>
              <SwipeActions.Bottom>
                ...
                <Card>
                  <Card.Content className="flex flex-col items-center gap-1 py-6 text-center">
                    ...
                    <p className="text-xs text-muted-foreground">
                      Reveals Top or Bottom action slots
                    </p>
                  </Card.Content>
                </Card>
              </SwipeActions.Content>
  ...
  <SwipeActions.Content>
    <Card>...</Card>
        ...
        },
        {
          ...
          description:
            "Left, Right, Top, and Bottom slots active simultaneously.",
          preview: (
            <SwipeActions className="w-full max-w-sm rounded-xl">
              <SwipeActions.Left>
                <SwipeActions.Action variant="success">
                  <Check /> Done
                </SwipeActions.Action>
              </SwipeActions.Left>
              <SwipeActions.Right>
      ...
      props={[
        {
          ...
          type: "boolean",
          default: "false",
          description: "Disables all swipe interactions.",
        },
        {
          name: "threshold",
          type: "number",
        ...
        },
        {
          ...
          default: "0.15",
          description:
            "Rubber-band resistance factor when dragging past the slot edge. Lower = more resistance (0–1).",
        },
        {
          name: "fullSwipe",
          type: "boolean",
          default: "false",
          description:
            "Allow a full-width swipe to immediately fire the primary action — ideal for swipe-to-pay / swipe-to-dismiss.",
        },
        {
          ...
          default: "0.55",
          description:
            "Fraction of container width needed to trigger a full swipe. Only applies when fullSwipe is true.",
        },
        {
          name: "onFullSwipe",
          type: "(side: SwipeSide) => void",
          description: "Called immediately when a full-swipe gesture fires.",
        },
        {
          name: "onOpenChange",
          type: "(side: SwipeSide) => void",
          description:
            'Called when the revealed side changes. Receives "left", "right", "top", "bottom", or null.',
        },
        {
          name: "Action › variant",
        ...
        {
          name: "Action › closeOnAction",
          type: "boolean",
          default: "true",
          description:
            "Auto-closes the panel after the action button is clicked.",
        },
      ]}
    />
  );
