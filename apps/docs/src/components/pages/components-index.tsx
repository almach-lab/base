...
function ComponentCard({
  ...
  return (
    ...
    >
      <div className="mb-2.5 flex h-32 items-center justify-center rounded-lg border border-border/60 bg-[radial-gradient(circle_at_top,color-mix(in_srgb,var(--color-primary)_16%,transparent),transparent_52%)] md:h-36">
