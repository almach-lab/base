...
export const DOC_COMPONENT_GROUPS: DocComponentGroup[] = [
	{
		...
		items: [
			...
			{ name: "Select", slug: "select", description: "Dropdown + searchable select." },
			{ name: "Switch", slug: "switch", description: "Toggle control with three sizes." },
			{ name: "Tag Input", slug: "tag-input", description: "Multi-value tag input field." },
	...
	},
	{
		name: "Display",
		items: [
			{ name: "Alert", slug: "alert", description: "Inline feedback messages." },
			{ name: "Avatar", slug: "avatar", description: "User image with fallback initials." },
			{ name: "Badge", slug: "badge", description: "Status labels and tags." },
			{ name: "Progress", slug: "progress", description: "Linear progress indicator." },
			{ name: "Skeleton", slug: "skeleton", description: "Shimmer loading placeholder." },
			{ name: "Toast", slug: "toast", description: "Transient notifications." },
			{ name: "Tooltip", slug: "tooltip", description: "Contextual hover hints." },
		],
	},
	{
		name: "Layout",
		items: [
			{ name: "Card", slug: "card", description: "Surface container with sections." },
			{ name: "Carousel", slug: "carousel", description: "Touch-friendly slide carousel." },
			{ name: "Separator", slug: "separator", description: "Horizontal or vertical divider." },
			{ name: "Swipe Actions", slug: "swipe-actions", description: "Reveal actions by swiping a list item." },
		],
	},
	{
		name: "Overlay",
		items: [
			{ name: "Collapsible", slug: "collapsible", description: "Expand / collapse content." },
			{ name: "Command", slug: "command", description: "⌘K command palette with search." },
			{ name: "Dialog", slug: "dialog", description: "Modal overlay with focus trapping." },
	...
	},
	{
		name: "Data",
		items: [
			{ name: "Chart", slug: "chart", description: "Line, Bar, Area, Pie, and Radar charts." },
			{ name: "Calendar", slug: "calendar", description: "Date and date range picker." },
			{ name: "Table", slug: "table", description: "TanStack-powered data table." },
		],
	},
];
